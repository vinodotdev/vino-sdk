  ...
  match value {
    Packet::Success(success) => match success {
      Serialized::MessagePack(v) => {
        vino_codec::messagepack::deserialize(&v).map_err(|e| Error::DeserializationError(e))
      }
      Serialized::Struct(v) => vino_codec::raw::deserialize(v).map_err(|e| Error::DeserializationError(e)),
      Serialized::Json(v) => vino_codec::json::deserialize(&v).map_err(|e| Error::DeserializationError(e)),
    },
